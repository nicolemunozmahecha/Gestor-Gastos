...
**Project Description:**
This project is an application designed to serve as a personal and shared expense manager. It allows users to register expenses, organize them by category, set up alerts when spending limits are reached, and view statistics on expenses incurred.

**How to Run the Project:**
1. Clone the GitHub repository. To do so, run:
```bash
git clone [https://github.com/Guillermo-MR/TDS.git](https://github.com/Guillermo-MR/TDS.git)
