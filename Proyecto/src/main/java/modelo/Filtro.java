...
public class Filtro {
    ...
    public Filtro(List<String> meses, LocalDate fechaInicio, LocalDate fechaFin, List<Categoria> categorias) {
    ...
    public Filtro(LocalDate fechaInicio, LocalDate fechaFin) {
        this(null, fechaInicio, fechaFin, null);
    }

    public Filtro(List<Categoria> categorias) {
        this(null, null, null, categorias);
    }
    
    public static Filtro porMeses(List<String> meses) {
        return new Filtro(meses, null, null, null);
    }
